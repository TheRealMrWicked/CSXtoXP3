...
@AddSelect text=Từ　giờ　hãy　quan　tâm　đến　mình nhé. hint=奈緒
@AddSelect text=Cả　hai　đều　trưởng　thành　cả　rồi,　phải　không? hint=瑛/一葉/初佳
@StartSelect
