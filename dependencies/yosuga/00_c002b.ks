...
@Char file=CF01_06M 
@Update
@Move id=ó∫ïΩ my=800 cycle=1000
@WaitAction id=ó∫ïΩ
...
@update time=0
@action id=ìﬁèè action=ActionAdvHop width=35 height=2 cycle=150 count=2
@WaitAction id=ìﬁèè
